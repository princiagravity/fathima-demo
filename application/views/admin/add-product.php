                                 ...
                                 <select class="form-control select_variant" id="exampleFormControlSelect1" name="prod_det[variants][]">
...

                                    {
...

                                       {
                                          ...
                                          <option selected="" value="8" ><?php echo $value; ?></option> 
...
/>
                              ...
                              <button type="button" class="btn btn-primary" id="add_more" style="">Add more</button>
                              </div>
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     ...
                     <div class="iq-card-body">
                        ...
                        <div class="table-responsive">
                           ...
                           <table id="productlist" class="table mb-0 table-borderless">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">New Stock Details</h5>
