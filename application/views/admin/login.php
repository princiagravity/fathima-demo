          ...
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><img class="big-logo" src="img/core-img/logo-white.png" alt="">
            ...
            <form id="user-login" method="POST" action="" data-form="ajaxform" enctype="multipart/form-data">
                <div class="form-group text-start mb-4"><span>Username</span>
                  ...
                  <input class="form-control" id="username" name="username" type="text"  required><!-- info@example.com -->
                </div>
                <div class="form-group text-start mb-4"><span>Password</span>
                  <label for="password"><i class="lni lni-lock"></i></label>
                  <input class="form-control" id="password" name="password" type="password" placeholder="Password" required>
                </div>
                <button class="btn btn-secondary btn-lg w-100" type="submit">Log In</button>
              </form>
            </div>
            <!-- Login Meta-->
