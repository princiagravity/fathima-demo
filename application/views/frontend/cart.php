          ...
          <div class="cart-table card mb-3">
            <div class="table-responsive card-body">
              <table class="table mb-0">
                ...
                if($cart_list)
                {
                foreach($cart_list as $index=>$value)
                {                 
                 ...
                 ?>
                  <tr>
                    <th scope="row ">
                    <input type="hidden" name="cart_id" class="cart_id" value="<?php echo $index; ?>" >
                    <input type="hidden" name="prod_id" class="prod_id" value="<?php echo $value['product_id']; ?>" >
                    <input type="hidden" name="prod_type" class="prod_type" value="<?php echo $value['type']; ?>" >
                    <input type="hidden" name="prod_total" class="prod_total" value="<?php echo $value['product_total']; ?>" >
                    <input type="hidden" name="prod_count" class="prod_count" value="<?php echo $value['product_count']; ?>" >
                    <input type="hidden" name="prod_variant" class="prod_variant" value="<?php echo $value['product_variant']; ?>" >
                    <a class="remove-product" href="#"><i class="lni lni-close"></i></a></th>
                    <td><a href="#"><?php echo $value['product_name']?><span><!--<i class="lni lni-rupee"></i>--> AED <?php echo $value['product_price'];?></span></a></td>
                     <td class="">
                      <?php if($value['product_variant']=="offer-product"){ 
                        $offer_product=$value['product_name'];
   ...
   <input class=" prod_count form-control cart-quantity-input" style="max-width: 40px;
    ...
    text-align: center;
    font-weight: 700;
    padding: 0.375rem 0.5rem;" type="text" step="1" id="<?php echo $index?>" name="prod_quantity" value="<?php echo $value['product_count']; ?>" data-type="<?php echo $value['type']; ?>" data-variant="<?php echo $value['product_variant']?>" data-prod="<?php echo $value['product_id']?>" >
   ...
   ">+</div>
    ...
    <!-- <div class="quantity">
                        <input class="qty-text" type="text" value="<?php echo $value['product_count']; ?>">
                        </div> -->
                    
                     <?php }?>
                    </td>
                    <td>
                    <input type="hidden" name="upd_prod_id" class="upd_prod_id_<?php echo $index;?>" value="<?php echo $value['product_id'];?>">
                       <input type="hidden" name="upd_prod_var" class="upd_prod_var_<?php echo $index;?>" value="<?php echo $value['product_variant'];?>">
                      <div class="quantity">
                        <span class="text-muted">AED</span>
                        <input class="qty-text" style="border: none;background-color: white;text-align:left;" id="<?php echo $index.'total';?>" type="text" value="<?php echo $value['product_total']; ?>" disabled>
                      </div>
                    </td>
                  </tr>
          ...
          <div class="cart-table card" style="margin-bottom: 4%;">
            ...
            <div class="card-body"  style="min-height:77px">
                ...
                <ul class="ps-0">
                    ...
                    <img src="<?php echo base_url();?>images/take-away.png" style="display: block;
    ...
    color: #000;">Take Away </span></label>
            ...
            <div class="card-body"  style="min-height:77px">
                ...
                <ul class="ps-0">
                    ...
                    <img src="<?php echo base_url();?>images/delivery.png" style="display: block;
    margin: 0px auto;"/> 	<span style="text-align: center;
    margin: 0px auto;
    display: block;
    font-size: 14px;
