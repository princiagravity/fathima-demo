              ...
              <div class="card-body" style="min-height:135px">
                <div class="shipping-method-choose">
                  <ul class="ps-0">
                    ...
                    <img src="<?php echo base_url();?>images/cash-on-delivery.png" style="display: block;
                ...
                <div class="shipping-method-choose">
                  <ul class="ps-0">
                    ...
                    <li>
                     ...
                     <img src="<?php echo base_url();?>images/debit-card.png" style="display: block;
    margin: 0px auto;"/><span style="text-align: center;
    margin: 0px auto;
    display: block;
    font-size: 14px;
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="" method="POST" id="paymentFrm">
           ...
           <br> <span id="stripestatus" style="display: none;" class="text-success">Please Wait.. Your transaction is being processed<img src="<?php echo base_url().'images/loading.gif'?>" style="no-repeat 50% 50%;width: 50px;height:50px"></span>
        </form>
          </div>
    </div>
  </div>
