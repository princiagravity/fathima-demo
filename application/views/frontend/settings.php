        ...
        <div class="settings-wrapper py-3">
          ...
          <div class="card settings-card">
            <div class="card-body">
              ...
              <div class="single-settings d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><a href="#!">English<i class="lni lni-chevron-right"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Setting Card-->
          <div class="card settings-card">
            <div class="card-body">
              <!-- Single Settings-->
              <div class="single-settings d-flex align-items-center justify-content-between">
                <div class="title"><i class="lni lni-whatsapp"></i><span>Support</span></div>
                <div class="data-content"><a href="https://wa.me/+971525203040">Get Help<i class="lni lni-chevron-right"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Setting Card-->
