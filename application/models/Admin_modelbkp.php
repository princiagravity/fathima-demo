...
class Admin_model extends CI_Model {
        ...
        {
            $query   = $this->db->query("SELECT id,customer_id,delivery_boy_id,area,cart_total,discount,invoice_no,order_time,tax,delivery_charge,delivery_tax,total_before_vat,tax_amount,order_total,payment_type,delivery_type,status,loc_latitude,loc_longitude from order_details where id=$order_id");
